...
namespace TeamplateHotel.Controllers
{
    public class CommentController : BasicController
    {
        ...
        // ds nhan vien
        public static List<Employee> GetEmployees(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                List<Employee> employees = db.Employees.Where(a => a.LanguageID == lan).ToList();
                return employees;
            }
            
        }
        // ds danh mục
        public static List<ListMenu> GetListMenus(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                List<ListMenu> listMenus = db.ListMenus.Where(a => a.LanguageID== lan).ToList();
                return listMenus;
            }
        }
        //ds thuc don danh muc
        public static List<MenuRestaurant> GetMenuRestaurants(int ID)
        {
            using (var db = new MyDbDataContext())
            {
                List<MenuRestaurant> listMenus = db.MenuRestaurants.Where(a => a.MenuID == ID).ToList();
                return listMenus;
            }
        }
        //count comment
        ...
        //sl mon an
        public static int CountMenuRestaurant()
        {
            using (var db = new MyDbDataContext())
            {
                int count = db.MenuRestaurants.Where(a=>a.Status).Count();
                return count;
            }
        }
        // rating
        ...
        public static List<ShowObject> GetRoomBasicFacility(int id)
        {
            using (var db = new MyDbDataContext())
            {
                List<ShowObject> objects = db.Facilities.Where(a => a.Premium == false)
        ...
        public static List<ShowObject> GetRoomPremiumFacility(int id)
        {
            using (var db = new MyDbDataContext())
            {
                List<ShowObject> objects = db.Facilities.Where(a => a.Premium)
                    .Join(db.RoomFacilities.Where(a => a.RoomID == id), a => a.ID, b => b.FacilityID, (a, b) => new ShowObject
                    {
                        ID = a.ID,
                        Title = a.Title,
        ...
        public static List<Article> HomeRestaurantArticles(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                var memu =
                    db.Menus.FirstOrDefault(a => a.Type == SystemMenuType.Restaurant && a.LanguageID == languageKey) ??
                    new Menu();
        ...
        public static List<Question> questions(string lan)
        {
            using(var db = new MyDbDataContext())
            {
                List<Question> questions = db.Questions.Where(a => a.Status && a.Home && a.LanguageID == lan).ToList();
                return questions;
            }
        }
        public static List<Question> GetQuestions(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                List<Question> questions = db.Questions.Where(a => a.Status && a.LanguageID == lan).ToList();
                return questions;
            }
        }
    }
