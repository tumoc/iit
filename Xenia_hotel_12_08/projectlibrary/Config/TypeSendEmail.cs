...
namespace ProjectLibrary.Config
{
    public class TypeSendEmail
    {
        ...
        public static int OnePayTransaction = 7;
        public static int BookingRestaurant = 8;
        ...
        public static List<ListItem> ListTypeSendEmail()
        {
            var listTypeSendEmail = new List<ListItem>
            {
                ...
                new ListItem
                {
                    ...
                    new ListItem
                    {
                        Value = OnePayTransaction.ToString(),
                        Text = "Thanh toán onepay",
                    },new ListItem
                    {
                        Value = BookingRestaurant.ToString(),
                        Text = "Đặt service restaurant",
                    },
            };
