...
namespace ProjectLibrary.Database
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="xenia_db")]
    ...
    partial void InsertBookingRestaurant(BookingRestaurant instance);
    partial void UpdateBookingRestaurant(BookingRestaurant instance);
    partial void DeleteBookingRestaurant(BookingRestaurant instance);
    ...
    partial void InsertSpa(Spa instance);
    partial void UpdateSpa(Spa instance);
    partial void DeleteSpa(Spa instance);
    ...
    partial void DeleteUser(User instance);
		...
		public MyDbDataContext() : 
				base(global::ProjectLibrary.Properties.Settings.Default.xenia_dbConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Wine> Wines
		{
			get
			{
		...
		public System.Data.Linq.Table<BookingRestaurant> BookingRestaurants
		{
			get
			{
				return this.GetTable<BookingRestaurant>();
			}
		}
		...
		public System.Data.Linq.Table<Spa> Spas
		{
			get
			{
				return this.GetTable<Spa>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Wine")]
    ...
    partial void OnLanguageIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Fromto", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Language_Wine", Storage="_Language", ThisKey="LanguageID", OtherKey="ID", IsForeignKey=true)]
		public Language Language
		{
			get
			{
			...
			set
			{
							...
							|| (this._Language.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Language.Entity = null;
						previousValue.Wines.Remove(this);
					}
					this._Language.Entity = value;
					if ((value != null))
					{
						value.Wines.Add(this);
						this._LanguageID = value.ID;
					}
					else
					{
	...
	public partial class Amenity : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ArticleAmenity> _ArticleAmenities;
    ...
    partial void OnlanguageIDChanged();
		...
		public Amenity()
		{
			this._ArticleAmenities = new EntitySet<ArticleAmenity>(new Action<ArticleAmenity>(this.attach_ArticleAmenities), new Action<ArticleAmenity>(this.detach_ArticleAmenities));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Amenity_ArticleAmenity", Storage="_ArticleAmenities", ThisKey="ID", OtherKey="AmenityID")]
		public EntitySet<ArticleAmenity> ArticleAmenities
		{
			get
			{
				return this._ArticleAmenities;
			}
			set
			{
				this._ArticleAmenities.Assign(value);
			}
		}
		...
		private void attach_ArticleAmenities(ArticleAmenity entity)
		{
			this.SendPropertyChanging();
			entity.Amenity = this;
		}
		
		private void detach_ArticleAmenities(ArticleAmenity entity)
		{
			this.SendPropertyChanging();
			entity.Amenity = null;
		}
    ...
    partial void OnCustomerChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Article_ArticleAmenity", Storage="_ArticleAmenities", ThisKey="ID", OtherKey="ArticleID")]
		public EntitySet<ArticleAmenity> ArticleAmenities
		{
			get
			{
	...
	public partial class ArticleAmenity : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _AmenityID;
    ...
    partial void OnAmenityIDChanging(System.Nullable<int> value);
    partial void OnAmenityIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AmenityID", DbType="Int")]
		public System.Nullable<int> AmenityID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Amenity_ArticleAmenity", Storage="_Amenity", ThisKey="AmenityID", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Amenity.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ArticleAmenities.Remove(this);
					}
					this._Amenity.Entity = value;
					if ((value != null))
					{
						value.ArticleAmenities.Add(this);
						this._AmenityID = value.ID;
					}
					else
					{
						this._AmenityID = default(Nullable<int>);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Article_ArticleAmenity", Storage="_Article", ThisKey="ArticleID", OtherKey="ID", IsForeignKey=true)]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.BookingRestaurant")]
	public partial class BookingRestaurant : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnInfoBookingChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Request", DbType="NVarChar(50)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InfoBooking", DbType="NVarChar(200) NOT NULL", CanBeNull=false)]
    ...
    partial void OnDefaultChanged();
		...
		public Language()
		{
			...
			this._Wines = new EntitySet<Wine>(new Action<Wine>(this.attach_Wines), new Action<Wine>(this.detach_Wines));
			...
			this._Spas = new EntitySet<Spa>(new Action<Spa>(this.attach_Spas), new Action<Spa>(this.detach_Spas));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Language_Wine", Storage="_Wines", ThisKey="ID", OtherKey="LanguageID")]
		public EntitySet<Wine> Wines
		{
			get
			{
				return this._Wines;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Language_Spa", Storage="_Spas", ThisKey="ID", OtherKey="LanguageID")]
		public EntitySet<Spa> Spas
		{
			get
			{
				return this._Spas;
		...
		private void attach_Wines(Wine entity)
		{
			this.SendPropertyChanging();
			entity.Language = this;
		}
		
		private void detach_Wines(Wine entity)
		{
			this.SendPropertyChanging();
			entity.Language = null;
		}
		...
		private void attach_Spas(Spa entity)
		{
			this.SendPropertyChanging();
			entity.Language = this;
		}
		
		private void detach_Spas(Spa entity)
		{
			this.SendPropertyChanging();
			entity.Language = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Spa")]
	public partial class Spa : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnHomeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Language_Spa", Storage="_Language", ThisKey="LanguageID", OtherKey="ID", IsForeignKey=true)]
		public Language Language
		{
			get
			{
			...
			set
			{
							...
							|| (this._Language.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Language.Entity = null;
						previousValue.Spas.Remove(this);
					}
					this._Language.Entity = value;
					if ((value != null))
					{
