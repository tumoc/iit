...
namespace TeamplateHotel.Controllers
{
    public class CommentController : BasicController
    {
        ...
        //
        public static Menu menu1(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                return db.Menus.Where(a => a.LanguageID == lan && a.Type == SystemMenuType.Home).FirstOrDefault();
            }
        }
        public static Menu Contact(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                return db.Menus.Where(a => a.LanguageID == lan && a.Type == SystemMenuType.Contact).FirstOrDefault();
            }
        }
        public static string menu(string lan, int id)
        {
            using (var db = new MyDbDataContext())
            {
                return db.Menus.Where(a => a.LanguageID == lan && a.ID==id).Select(a=>a.Title).FirstOrDefault();
            }
        }
        // ds menu gallery
        public static List<int> MenuGallery(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                List<int> list = db.Galleries.Join(db.Menus.Where(a => a.LanguageID == lan), a => a.MenuId, b => b.ID,
                            (a, b) => new ShowObject
                            {
                                ID = a.MenuId,
        ...
        //Danh sách gallery theo menu
        public static List<Gallery> Gallery(int MenuId)
        {
            using (var db = new MyDbDataContext())
            {
                List<Gallery> galleries = db.Galleries.Where(a=>a.MenuId==MenuId).OrderBy(a => a.Index).ToList();
                return galleries;
            }
        }
        // danh sach gallery 
        ...
        //tang view
        public static void Plus(int id)
        {
            using (var db = new MyDbDataContext())
            {
                Article article = db.Articles.FirstOrDefault(b => b.ID == id);
        ...
        //count comment
        public static int countcmt(int id)
        {
            using (var db = new MyDbDataContext())
            {
                int num = db.Comments.Where(a=> a.ArticleID == id).Count();
                return num;
            }
        }
        public static List<Comment> GetComments(int id)
        {
            using (var db = new MyDbDataContext())
            {
                List<Comment> list = db.Comments.Where(a => a.ArticleID == id).ToList();
                return list;
            }
        }
        ...
        public static int CountReview()
        {
            using (var db = new MyDbDataContext())
            {
                int count = db.FeedBacks.Where(a => a.Star == 5).Count();
                return count;
            }
        }
        // rating
        ...
        public static List<Article> GetActivityArticles(int menuId)
        {
            using (var db = new MyDbDataContext())
            {
        ...
        public static List<Article> GetServiceArticles(int menuId)
        {
            using (var db = new MyDbDataContext())
            {
                List<Article> articles = db.Articles.Where(a => a.MenuID == menuId && a.Status && a.Hot == false).OrderBy(a => a.Index).ToList();
        ...
        public static List<Amenity> GetArticleAmetities(int articleID)
        {
            using (var db = new MyDbDataContext())
            {
                List<int> id = db.ArticleAmenities.Where(a=>a.ArticleID== articleID).Select(a=>a.AmentityID).ToList();
                List<Amenity> amenities = db.Amenities.Where(a => a.Status && id.Contains(a.ID)).ToList();
                return amenities;
            }
        }
        public static List<Facility> GetHotFacility()
        {
            using (var db = new MyDbDataContext())
            {
                List<Facility> objects = db.Facilities.Where(a => a.Hot).ToList();
                return objects;
            }
        }
        public static List<Facility> GetFacility(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                List<Facility> objects = db.Facilities.Where(a=>a.LanguageID == lan).ToList();
                return objects;
            }
        }
        public static List<ShowObject> GetRoomBasicFacility(int id)
        {
            using (var db = new MyDbDataContext())
            {
                List<ShowObject> objects = db.Facilities
                    .Join(db.RoomFacilities.Where(a => a.RoomID == id), a => a.ID, b => b.FacilityID, (a, b) => new ShowObject
                    {
                        ID = a.ID,
                        Title = a.Title,
                    }).ToList();
        ...
        public static List<Service> OrtherService(int Id)
        {
            using (var db = new MyDbDataContext())
            {
                List<Service> restaurants = db.Services.Where(a => a.Status && a.ID!=Id).OrderBy(a => a.Index).ToList();
                foreach (var restaurant in restaurants)
                {
                    restaurant.MenuAlias = restaurant.Menu.Alias;
                }
        ...
        //bai viet index
        public static ShowObject HomeHotArticle(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                ShowObject articleHots = db.Articles.Where(a => a.Hot && a.Status)
                        .Join(db.Menus.Where(a => a.Type == SystemMenuType.Home && a.LanguageID== languageKey), a => a.MenuID, b => b.ID,
                            (a, b) => new ShowObject
                            {
                                ID = a.ID,
                                Alias = a.Alias,
        ...
        public static List<ShowObject> HomeArticles(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                var memu =
                    ...
                    new Menu();
                List<ShowObject> articleHomes = db.Articles.Where(a => a.Status && a.Customer==false && a.Hot==false)
                        .Join(db.Menus.Where(a => a.ID == memu.ID), a => a.MenuID, b => b.ID,
                            (a, b) => new ShowObject
                            {
                                ID = a.ID,
                                Alias = a.Alias,
        ...
        public static List<Article> HomeActivityArticles(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                var memu =
                    db.Menus.FirstOrDefault(a => a.Type == SystemMenuType.Activity && a.LanguageID == languageKey) ??
                    new Menu();
                List<Article> articleHomes = db.Articles.Where(a => a.Home && a.Status && a.MenuID==memu.ID).OrderBy(a=>a.Index).ToList();
        ...
        public static List<Article> HomeRoomArticles(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                var memu =
        ...
        public static List<Service> HomeServices(string languageKey)
        {
            using (var db = new MyDbDataContext())
            {
                var memu =
                    db.Menus.FirstOrDefault(a => a.Type == SystemMenuType.Service && a.LanguageID == languageKey) ??
                    new Menu();
                List<Service> articleHomes = db.Services.Where(a => a.Home && a.Status && a.MenuID == memu.ID).OrderBy(a=>a.Index).ToList();
                foreach (var item in articleHomes)
                {
                    item.MenuAlias = memu.Alias;
                }
        ...
        public static Article HotArticle(int menuId)
        {
            using (var db = new MyDbDataContext())
            {
                return db.Articles.Where(a => a.MenuID == menuId && a.Hot && a.Home == false).OrderBy(a => a.Index).FirstOrDefault();
            }
        }
        ...
        public static Article PreviousArticle(int menuId,int id)
        {
            using (var db = new MyDbDataContext())
            {
                ...
                Article article= db.Articles.Where(a => a.MenuID == menuId && a.Status&& a.ID != id&& a.Datetime<date && a.Hot==false).OrderBy(a => a.Datetime).FirstOrDefault();
                if (article == null)
                {
                    return article;
                }
        ...
        public static Article NextArticle(int menuId, int id)
        {
            using (var db = new MyDbDataContext())
            {
                DateTime date = (DateTime)db.Articles.Where(a => a.ID == id).Select(a => a.Datetime).FirstOrDefault();
        ...
        public static List<ShowObject> CustomerArt(int menuId)
        {
            using (var db = new MyDbDataContext())
            {
                List<ShowObject> CustomerArticle = db.Articles.Where(a => a.Customer && a.Status)
                        .Join(db.Menus.Where(a => a.ID == menuId), a => a.MenuID, b => b.ID,
                            (a, b) => new ShowObject
                            {
                                ID = a.ID,
                                Alias = a.Alias,
        ...
        public static List<ShowObject> ArticleShowHome(string lang)
        {

            using (var db = new MyDbDataContext())
            {
                List<ShowObject> showObjects = db.Articles.Where(a => a.Home && a.Status)
                    .Join(db.Menus.Where(a => a.LanguageID == lang && a.Type == SystemMenuType.Article), a => a.MenuID, b => b.ID,
                        (a, b) => new ShowObject
                        {
                            ID = a.ID,
                            Alias = a.Alias,
        ...
        public static List<Award> GetAwards(string lan)
        {
            using (var db = new MyDbDataContext())
            {
                return db.Awards.Where(a => a.Status && a.LanguageID == lan).OrderBy(a=>a.Index).ToList();
            }
        }
    }
}